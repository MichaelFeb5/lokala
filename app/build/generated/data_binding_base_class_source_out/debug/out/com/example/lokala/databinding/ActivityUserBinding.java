...
public final class ActivityUserBinding implements ViewBinding {
  ...
  private ActivityUserBinding(@NonNull ConstraintLayout rootView,
      @NonNull MeowBottomNavigation bottomNavigation, @NonNull RelativeLayout containerUser) {
  ...
  public static ActivityUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout containerUser = ViewBindings.findChildViewById(rootView, id);
      if (containerUser == null) {
        break missingId;
      }

      return new ActivityUserBinding((ConstraintLayout) rootView, bottomNavigation, containerUser);
    }
